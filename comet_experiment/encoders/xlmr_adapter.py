...
class XLMREncoder_adapter(BERTEncoder):
    ...
    def __init__(self, pretrained_model: str) -> None:
        ...
        self.adapter_name = self.model.load_adapter('@ukp/xlm-roberta-base-en-wiki_pfeiffer')
    ...
    def from_pretrained(cls, pretrained_model: str) -> Encoder:
        ...
        """
        return XLMREncoder_adapter(pretrained_model)
