...
class XLMRXLEncoder_adapter(XLMREncoder):
    ...
    def __init__(self, pretrained_model: str) -> None:
        ...
        self.model = XLMRobertaAdapterModel.from_pretrained(
            pretrained_model, add_pooling_layer=False
        )
	self.adapter_name = model.load_adapter('@ukp/xlm-roberta-large-en-wiki_pfeiffer')
    ...
    def from_pretrained(cls, pretrained_model: str) -> Encoder:
        ...
        """
        return XLMRXLEncoder_adapter(pretrained_model)
